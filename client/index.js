...
const mq = [
  ...
  window.matchMedia('(min-width: 2497px) and (min-height: 500px)'),                         //40 => 37
  ...
  window.matchMedia('(min-width: 2497px) and (min-height: 620px)'),                         //40 => 75
  ...
  window.matchMedia('(min-width: 2497px) and (min-height: 850px)'),                         // 0 40 => 113
]
