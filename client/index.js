...
const mqws = [
  ...
  window.matchMedia('(min-width: 1225px) and (max-width: 1274px'),  //14
  window.matchMedia('(min-width: 1295px) and (max-width: 1334px'),  //15
  window.matchMedia('(min-width: 1375px) and (max-width: 1324px'),  //16--
...
const resizeSequencersResponsively = () => {
  ...
  mqws[20].addListener(e => {
    if(e.matches) {
      ...
      $(".synth-seq-header").width(576)
      $("#drum-seq-header").width(1162)
      $('.list-select').width(110)
      $('.select-sub-header').css('font-size', '13px')
      $('.select-container').width(130).css('margin-right', '0')
      $('#lead-select-container').width(117).css('margin-left', '2.7em')
      $('#drum-select-container').width(112).css('margin-right', '.6em').css('margin-left', '34px')
      $('#drum-effect-container').width(112).css('margin-left', '.6em')
